...
namespace FrunutStock.Web.Areas.Stock.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,AddedDate,ModifiedDate,UserName")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,AddedDate,ModifiedDate,UserName")] Country country)
        {
            if (ModelState.IsValid)
            {
